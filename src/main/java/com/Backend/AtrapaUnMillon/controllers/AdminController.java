...
public class AdminController {
    ...
    public ResponseEntity<Admin> login(
        ...
        Admin admin = adminService.login(username, passwordEncoder.encode(password));
        if (admin != null) {
    ...
    @Operation(summary = "Registro", tags = {"admins"})
    ...
    public ResponseEntity<Admin> register(
        ...
        try {
            ...
            Admin admin = adminService.signIn(username, hashedPassword, key);
            return new ResponseEntity<>(admin, HttpStatus.OK);
